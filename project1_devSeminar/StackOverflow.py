...
in the text pane.'''
    ...
    def write(self):
        try:
            request = requests.get('https://stackoverflow.com/jobs/feed?l=Bridgewater%2c+MA%2c+United+States&u=Miles&d=50')
...
#FollowThatTag.testFindAllText(str(lxml)


                #FollowThatTag(description)
